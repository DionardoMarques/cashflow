...
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    public async Task<byte[]> Execute(DateOnly month)
    {
        ...
        CreateHeaderWithProfilPhotoAndName(page);
    ...
    private Document CreateDocument(DateOnly month)
    {
        ...
        document.Info.Author = "Dionardo Marques";
    ...
    private void CreateHeaderWithProfilPhotoAndName(Section page)
    {
        ...
        row.Cells[1].AddParagraph($"{ResourceReportGenerationMessages.SAUDATION}, Dionardo Marques");
    ...
    private void CreateTotalSpentSection(Section page, DateOnly month, decimal totalExpenses)
    {
        ...
        paragraph.AddFormattedText($"{ResourceReportGenerationMessages.CURRENCY_SYMBOL} {totalExpenses}", new Font { Name = FontHelper.WORKSANS_BLACK, Size = 50 });
    }
    ...
    {
        cell.AddParagraph($"-{ResourceReportGenerationMessages.CURRENCY_SYMBOL} {amount}");
